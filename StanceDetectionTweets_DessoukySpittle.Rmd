...
Our model's results are summarized in the tables below. _\autoref{fig:classreport_table}_ shows the classification report for our model across all targets. _\autoref{fig:f1rank_table}_ shows the final ranking of our model in the context of the competing teams in the SemEval-2016 conference, the baseline SVM models, and the succeeding work by _@sun-etal-2018-stance _ and _@ijcai2017-557 _. _\autoref{fig:f1all_table}_ shows our F1 scores for each topic in comparison to all teams that achieved a high score in at least 1 topic as well as the SVM baseline, _@sun-etal-2018-stance _, and _@ijcai2017-557 _.
