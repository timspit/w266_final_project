...
Errors for target **Atheism** were manually reviewed by the authors to better understand the nature of mis-classified tweets. Errors were categorized according to whether the purported "true" label or the predicted label from our model appeared to be correct (or if neither appeared correct). \autoref{fig:error_analysis} in the *Appendix* shows the result of this error review and annotation.   
